...
const createSiteRouteInformation = () => {
  return (
...
render(siteCostElement, createSiteCostTravel(), `beforeEnd`);
...
render(siteSortingElement, createSortingTemplate(), `beforeEnd`);
render(siteSortingElement, createCreateFormTemplate(), `beforeEnd`);

for (let i = 0; i < TASK_COUNT; i++) {
  render(siteSortingElement, createRoutePointTemplate(), `beforeEnd`);
}
